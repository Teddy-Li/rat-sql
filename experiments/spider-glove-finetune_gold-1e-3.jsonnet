{
    logdir: "logdir/glove_run_finetune_gold_1e-3",
    trainset: "finetune_gold",
    valset: "test",
    ...
    eval_name: "glove_run_finetune_gold_1e-3_%s_%d" % [self.eval_use_heuristic, self.eval_beam_size],
