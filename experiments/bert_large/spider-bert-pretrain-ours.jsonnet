{
    logdir: "logdir/bert_large_run_pretrain_ours",
    initdir: "logdir/bert_large_run_pretrain_ours",
    ...
    eval_name: "bert_large_run_pretrain_ours_%s_%d" % [self.eval_use_heuristic, self.eval_beam_size],
