{
    logdir: "logdir/bert_large_run_finetune_oracle_1e-3",
    initdir: "logdir/bert_large_run_finetune_oracle_1e-3",
    ...
    eval_name: "bert_large_run_finetune_oracle_1e-3_%s_%d" % [self.eval_use_heuristic, self.eval_beam_size],
