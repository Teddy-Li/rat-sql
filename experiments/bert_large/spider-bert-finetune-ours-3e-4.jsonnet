{
    logdir: "logdir/bert_large_run_finetune_ours_3e-4",
    initdir: "logdir/bert_large_run_finetune_ours_3e-4",
    ...
    eval_name: "bert_large_run_finetune_ours_3e-4_%s_%d" % [self.eval_use_heuristic, self.eval_beam_size],
