{
    logdir: "logdir/bert_large_run_pretrain_irrelevant",
    initdir: "logdir/bert_large_run_pretrain_irrelevant",
    ...
    eval_name: "bert_large_run_pretrain_irrelevant_%s_%d" % [self.eval_use_heuristic, self.eval_beam_size],
