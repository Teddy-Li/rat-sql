{
    logdir: "logdir/bert_large_run_finetune_ours_1e-5",
    initdir: "logdir/bert_large_run_finetune_ours_1e-5",
    ...
    eval_name: "bert_large_run_finetune_ours_1e-5_%s_%d" % [self.eval_use_heuristic, self.eval_beam_size],
