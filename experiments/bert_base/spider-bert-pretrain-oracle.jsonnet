{
    logdir: "logdir/bert_base_run_pretrain_oracle",
    initdir: "logdir/bert_base_run_pretrain_oracle",
    ...
    eval_name: "bert_base_run_pretrain_oracle_%s_%d" % [self.eval_use_heuristic, self.eval_beam_size],
